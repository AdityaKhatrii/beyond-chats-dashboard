...
const useStyles = makeStyles((theme) => ({
	root: {
		...
		// outline: "0.1rem solid rgba(224, 224, 224, 0.3)",
		// backgroundColor: "rgba(251, 251, 251, 0.5)",
		background: "linear-gradient(0deg, rgba(28, 27, 51, 0.2), #2E335A)",
...
const CustomVector = ({ data, handleOpenEditDialog, handleDelete }) => {
		...
		<Box className={classes.root}>
			...
			<Box className={classes.footer_container}>
				<Box className={classes.details_container}>
					...
					<Typography variant="subtitle1" color="textSecondary" sx={{color:'white'}}>
